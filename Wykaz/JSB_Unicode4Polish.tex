...
% \begin{frame}
%   \frametitle{Projekt instrukcji wydawniczej dla źródeł historycznych
%     XIX i początku XX wieku}
%   Ihnatowicz I., Projekt instrukcji wydawniczej dla źródeł
%   historycznych XIX i początku XX wieku, „Studia Źródłoznawcze”
%   7(1962);

% \url{http://rcin.org.pl/publication/24489}
%   \url{http://mikmach.hg.pl/zrodla2/ihnatowicz.html}


%   Wolff A., Projekt instrukcji wydawniczej dla pisanych źródeł
%   historycznych do połowy XVI, „Studia Źródłoznawcze” 1(1957).
%   \url{http://mikmach.hg.pl/zrodla2/wolff.html}

%   https://pl.wikipedia.org/wiki/Kazimierz_Lepszy
  
%   Lepszy K., Instrukcja wydawnicza dla źródeł historycznych od XVI w. do poł. XIX w.,
%   Warszawa 1953;
  
%   \url{http://mikmach.hg.pl/zrodla2/lepszy.html}
...
postaciami przekreślonego @ i z @, które oddajemy przez ę. Transh-
terujemy a: kropką niezależnie od tego, litera ta posiada
...
i transliterujemy przez ajj. Jeżeli a i s (a ew.›i inne znaki, np.
w kształcie 6, 8, B, B) występują ”tej samej funkcji, dajemy

puławskim. czcionkę ij traktujemy jako ligaturę
i transliterujemy przez ajj. Jeżeli a i s (a ew.›i inne znaki, np.
...
Ogólnie biorąc: jeżeli między

funkcjonalne, transliteracji
zachowujemy. Nie odróżniamy jednak pozycyjnie zróżnicowanego a"
okrągłego (z) i ?, oddając oba te warianty przez z, oraz za normal-
nego i końcowego (3), transliterując stale m.
Znaki diakrytyczne użyte w zabytku przy spółgłoskach pozo—


transliterujemy dużymi. literami.
Wszelkie kształty paragrafu oddajemy jednolicie znakiem il.
We wstępie edytorskim opisujemy wszystkie warianty
